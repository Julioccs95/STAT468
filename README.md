...
-Open terminal in the IDE and enter the following command: "python -m venv venv"
...
- Activate the virtual environment by typing in the command prompt: "venv\Scripts\activate.bat"
